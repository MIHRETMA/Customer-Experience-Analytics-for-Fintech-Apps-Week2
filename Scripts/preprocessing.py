...
class ReviewPreprocessor:
    ...
    def check_missing_data(self):
        ...
        # Print a header for this step [1/5]
    ...
    def handle_missing_values(self):
        ...
        # Print a header for this step [2/5]
    ...
    def remove_duplicates(self):
        ...
        # Print a header for this step [3/5]
        print("\n[3/5] Checking duplicated data...")

        # Calculate the count of duplicate values for each column
        duplicates = self.df.duplicated().sum()
        # Calculate the percentage of duplicate values for each column
        duplicates_pct = (duplicates / len(self.df)) * 100

        # Print the section header
        if duplicates > 0:
            print("\nDuplicate values:")
        # Loop through each column name in the index of the 'duplicates' series if there are duplicates
            for col in duplicates.index:
                # If the column has at least one duplicate value
                if duplicates[col] > 0:
                    # Print the column name, count of duplicate values, and percentage
                    print(f"  {col}: {duplicates[col]} ({duplicates_pct[col]:.2f}%)")
        
        self.df = self.df.drop_duplicates()
        # Print a message indicating how many duplicates were removed
        print(f"Removed {duplicates} duplicate reviews")

    def normalize_dates(self):
        """Normalize date formats to YYYY-MM-DD"""
        # Print a header for this step [4/5]
    ...
    def prepare_final_output(self):
        ...
        # Print a header for this step [5/5]
